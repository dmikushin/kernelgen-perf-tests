...
TARGETS_CUDA_CLEAN = $(addsuffix .cuda.clean, $(TARGETS))
...
clean: $(TARGETS_GCC_CLEAN) $(TARGETS_KERNELGEN_CLEAN) $(TARGETS_MIC_CLEAN) $(TARGETS_PATHSCALE_CLEAN) $(TARGETS_PGI_CLEAN) $(TARGETS_CAPS_CLEAN) $(TARGETS_CUDA_CLEAN) $(TARGETS_PATUS_CLEAN)
